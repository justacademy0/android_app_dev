        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              <a href="#home"      className="text-gray-900 hover:text-[#B51C72] px-3 py-2 text-sm font-medium">Home</a>
              <a href="#curriculum" className="text-gray-900 hover:text-[#B51C72] px-3 py-2 text-sm font-medium">Curriculum</a>
              <a href="#whatuget"   className="text-gray-900 hover:text-[#B51C72] px-3 py-2 text-sm font-medium">What You Get</a>
              <a href="#about"      className="text-gray-700 hover:text-[#B51C72] px-3 py-2 text-sm font-medium">About</a>
              <a
                href="#contact"
